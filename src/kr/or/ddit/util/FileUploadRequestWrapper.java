...
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
   ...
   // public static final String UPLOAD_DIRECTORY = "d:/D_Other/upload_files";	
    public static final String UPLOAD_DIRECTORY = "d:/A_TeachingMaterial/4.MiddleProject/workspace/FireMoth/WebContent/uploadImage";	
    ...
    private Map<String, FileItem[]> fileItemMap;	    // fileItem객체를 담기위한 맵,여러개일 수 있으니 배열로 담음
            ...
            for (int i = 0 ; i < list.size() ; i++) {
                ...
                if (fileItem.isFormField()) { // 폼필드인 경우...
                    ...
                    if (values == null) { // 처음 만드는 경우...
                        ...
                        String[] tempValues = new String[values.length + 1];//임시 배열을 만드는 과정 배열의 단점
                	...
                	if(fileItem.getSize() > 0) { // 파일이 존재하는 경우...
                        ...
                        if (values == null) { // 처음 만드는 경우... 동일한 값을 처리하기 위해 배열로 선언?
