...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	List<FaqVO> list = (List<FaqVO>)request.getAttribute("FaqAll");
%>
				...
				<div id="content_box">
					<div id="content_box_container">
						...
						<div id="faq_search_box">
							<select id="faq_search_filter">
								<option>제목</option>
								<option>내용</option>
							</select>
							
							<input type="text" name="faq_search" placeholder="검색어를 입력해주세요." id="faq_search_input">
							<input type="button" value="검색" id="faq_search_button" class="base_btn">
						</div>
						<br><br>
						
						<table border="1" id="faq_table">
							<tr>
								<th class="left_border_none">번호</th>
								<th class="right_border_none">제목</th>
							</tr>
							<%
							...
							%>
							<tr>
								<td class="left_border_none"><p><%=list.get(i).getFaq_no()%></p></td>
								<td class="right_border_none"><a href="SelectFaq.do?faq_no=<%=list.get(i).getFaq_no()%>" class="faq_title_box"><%=list.get(i).getFaq_title()%></td>
							</tr>
							<%
									}
								}
