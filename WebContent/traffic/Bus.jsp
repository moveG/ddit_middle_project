			...
			<div id="nav_container">
				...
				<div id="content_box">
					<div id="content_box_container">
						<h1 class="big_title_h1">버스</h1>
						<div class="t_container">
							<div class="t_box">
								<img alt="고속버스" src="/FireMoth/img/bus1.PNG" class="t_img">
								<h1 class="t_title_h1">고속버스 예약사이트</h1>
								<button onclick="location='https://www.kobus.co.kr/main.do'" class="base_btn">바로가기</button>
							</div>
							<div class="t_box">
								<img alt="시외버스" src="/FireMoth/img/bus2.PNG" class="t_img">
								<h1 class="t_title_h1">시외버스 예약사이트</h1>
								<button onclick="location='https://txbus.t-money.co.kr/main.do'" class="base_btn">바로가기</button>
							</div>
						</div>
