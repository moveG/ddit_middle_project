...
<head>
  ...
  <link rel="stylesheet" href="/FireMoth/traffic/air.css">
<title>교통편-항공</title>
			...
			<div id="nav_container">
				...
				<div id="content_box">
					<div id="content_box_container">
						<h1 class="big_title_h1">항공</h1>
						<div class="t_container">
							<div class="t_box">
								<img alt="대한항공" src="/FireMoth/img/air1.jpg" class="t_img">
								<h1 class="t_title_h1">대한항공 예약사이트</h1>
								<button onclick="location='https://www.koreanair.com/kr/ko?NaPm=ct%3Dkv61cv1n%7Cci%3Dcheckout%7Ctr%3Dds%7Ctrx%3D%7Chk%3D20829b99d62c06e224a9e472b633bc001dff2f41'" class="base_btn">바로가기</button>
							</div>
							<div class="t_box">
								<img alt="아시아나항공" src="/FireMoth/img/air2.jpg" class="t_img">
								<h1 class="t_title_h1">아시아나항공 예약사이트</h1>
								<button onclick="location='https://flyasiana.com/C/KR/KO/index'" class="base_btn">바로가기</button>
							</div>
							<div class="t_box">
								<img alt="유나이티드항공" src="/FireMoth/img/air3.jpg" class="t_img">
								<h1 class="t_title_h1">유나이티드항공 예약사이트</h1>
								<button onclick="location='https://www.united.com/ko/kr'" class="base_btn">바로가기</button>
							</div>
						</div>
