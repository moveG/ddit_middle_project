...
<%
	...
	List<StayVO> vo = (List<StayVO>)request.getAttribute("staylist");
...
<head>
  ...
  <link rel="stylesheet" href="/FireMoth/cart/mycart_css.css">
				...
				<div id="content_box">
					<div id="content_box_container">
						...
						<br>
							...
							<div id="z_list_container">
							 <form id="delete" action="/FireMoth/deleteCart.do">
								<%
									int Size = vo.size();
									if(Size > 0 ){
								...
								%>
											...
											<div class="z_div">
												...
												<input type="checkbox" name="stay_id" value="<%=vo.get(i).getStay_id()%>" class="z_chk">
												
												
												<%
										if(atchList.get(i) != null){
												%>			
												<img  onclick="location.href='/FireMoth/reservation/StayDetail.do?stay_id=<%= vo.get(i).getStay_id() %>&atch_file_id=<%= vo.get(i).getAtch_file_id() %>'"
												
												class="z_img" src="<%= request.getContextPath() %>/filedownload.do?fileId=<%= atchList.get(i).getAtchFileId() %>&fileSn=<%= atchList.get(i).getFileSn() %>">
												<%			
											}
												...
												<div class="z_info">
													<div class="z_info1">
														<div class="z_stay_name"><h2 class="z_h2"><%=vo.get(i).getStay_name() %></h2></div>
														<br>
														<p class="p">최대 수용인원 : <%=vo.get(i).getStay_pnum() %></p>
														<p class="p">가격 : <%=vo.get(i).getStay_price() %></p>
														<p class="p">주소 : <%=vo.get(i).getStay_add() %></p>
													</div>
													
													<div class="z_info2">
														<input type="button" class="base_btn" value="삭제">
													</div>
								...
								<div class="z_button_box">
									<input type="submit" value="선택삭제" class="base_btn">
								</div>
							</form>
