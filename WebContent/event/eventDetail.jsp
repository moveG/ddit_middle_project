...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <%
   	 ...
   	 EventVO vo = (EventVO)request.getAttribute("eventVO");
			...
			<div id="nav_container">
				<div id="aside">
					<div id="aside_container">
						<div class="aside_menu" id="aside_menu1"><a href="/FireMoth/EventSelect.do" class="aside_menu_a">이벤트&혜택</a></div>
				...
				<div id="content_box">
					<div id="content_box_container">
							...
							<%
								int num = Integer.parseInt(vo.getEvent_content());
							...
							<br>
							<img class="event_detail_img" src='/FireMoth/img/event_detail_img<%=num%>.PNG' alt='이미지없음'>
						 	<br>작성일자 : <%=vo.getEvent_date() %><br>
								
						<!-- <button id="btnEventList" onclick="location='/FireMoth/EventSelect.do'">목록으로</button> -->
