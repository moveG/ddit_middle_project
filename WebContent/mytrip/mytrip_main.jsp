			...
			<div id="header_container">
				...
				<div class="inr" id="inr2">
					<div id="page_name_box">
						<img alt="로고" id="logoimg" src="../img/logo.PNG">
						<a id="page_name" href="#">Come&Stay</a>
					</div>
					<div class="serchform">
			...
			<div id="nav_container">
				<div id="aside">
					<div id="aside_container">
						...
						<div class="aside_menu" id="aside_menu3"><a href="myTripInsert.jsp" class="aside_menu_a">나만의 여행지 등록</a></div>
					</div>
				</div>
