				...
				<div class="inr" id="inr3">
						...
						<div id="menudrop">
							<ul>
								...
								<li><a href="#" class="category">나만의 여행지</a></li>
								<li><a href="#" class="category">혜택/이벤트</a></li>
								<li><a href="#" class="category">공지사항</a></li>
			...
			<div id="nav_container">
				<div id="aside">
					<div id="aside_container">
						<div class="aside_menu" id="aside_menu1"><a href="#" class="aside_menu_a">서울</a></div>
						<div class="aside_menu" id="aside_menu2"><a href="#" class="aside_menu_a">강원도</a></div>
						<div class="aside_menu" id="aside_menu3"><a href="#" class="aside_menu_a">충청도</a></div>
						<div class="aside_menu" id="aside_menu4"><a href="#" class="aside_menu_a">전라도</a></div>
						<div class="aside_menu" id="aside_menu5"><a href="#" class="aside_menu_a">경상도</a></div>
						<div class="aside_menu" id="aside_menu6"><a href="#" class="aside_menu_a">제주도</a></div>
					</div>
				</div>
