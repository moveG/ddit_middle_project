...
function requestPay() {
    ...
    IMP.request_pay({ // param
        pg: "html5_inicis",
        pay_method: "card", //카드
        merchant_uid: 'merchant_' + new Date().getTime(), //상품 고유아이디
        name: "노르웨이 회전 의자", //제품명
        amount: 900, //가격
        buyer_email: "gildong@gmail.com", // 구매자의 이메일
        buyer_name: "홍길동", // 구매자의 이름
        buyer_tel: "010-4242-4242", //구매자의 전화번호
        buyer_addr: "서울특별시 강남구 신사동", //구매자의 주소
